...
if __name__ == '__main__':
  ...
  #tweets = pickle.load(open('',"rb"))
  #sentiments = pickle.load(open('',"rb"))
  data = pickle.load(open('../word2vec/tweet_vec_train.pkl','rb'))
  ...
  #l[1] is sentiment text
  #l[0] is tweet text
  for l in data:
  	if l[1] == "compliment":
  		target = np.matrix('1;0;0')
  	elif l[1] == "displeasure":
	...
	if l[0]:
		loss, dWxh, dWhh, dWhy, dbh, dby, hprev = lossFun(l[0], target, hprev)
